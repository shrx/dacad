...
setup(
    ...
    entry_points={"console_scripts": ["dacad = dacad:cl_main", "dacad_r = dacad.recurse:cl_main"]},
    test_suite="tests",
    ...
    url="https://github.com/shrx/dacad",
    download_url="https://github.com/shrx/dacad/archive/%s.tar.gz" % (version),
